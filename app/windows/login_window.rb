class LoginWindow < NSWindow
  attr_reader :email_field, :password_field
  ...
  def build_window
    ...
    self.initialFirstResponder = @layout.email_field
  ...
  def set_title_and_frame
    ...
    self.setFrame([[(self.screen.frame.size.width / 2) - 150, (self.screen.frame.size.height / 2)], [300, 145]], display:true)
  end
